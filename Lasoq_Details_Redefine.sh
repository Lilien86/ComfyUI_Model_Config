...
mkdir -p models/diffusion_model || echo "    - diffusion_model directory already exists"
mkdir -p models/VAE || echo "    - VAE directory already exists"
mkdir -p models/CLIP || echo "    - CLIP directory already exists"
mkdir -p models/loras || echo "    - loras directory already exists"
mkdir -p models/upscale_models || echo "    - upscale_models directory already exists"
